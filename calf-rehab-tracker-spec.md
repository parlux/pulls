...
Bent-knee heel raises, 10kg, 2 × 15 each leg. Easy, well short of failure. Maintenance only — cut this first if time is tight.
...
- Right-leg assist level (for A-days only): dropdown — Heavy / Moderate / Light / Barely touching. This is the primary progress metric — should trend toward "Barely touching" over time.
- Prior day's activity: free text (e.g. "skated", "rode", "long walk", "nothing")
- Soreness next morning: free text or short note (optional)

Keep the log to just those fields — no rep maxes, no retesting, no extra metrics during the block.
